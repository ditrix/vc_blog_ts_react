...
## [2026-01-18] Виправлення UI адмінки та оновлення документації

### 1. Постановка задачи
- Виправити логіку іконок публікації (око має публікувати, закреслене око — знімати).
- Додати перемикач видимості пароля у форму логіна.
- Перекласти `README.md` українською мовою та додати інформацію про автора та вайбкодінг.

### 2. Виконання
- **FIX**: У таблицях статей та коментарів виправлено відображення іконок (`Eye` для публікації, `EyeOff` для приховування).
- **UI**: У форму входу додано кнопку-око для перемикання видимості пароля.
- **Docs**: `README.md` перекладено українською, додано дисклеймер про вивчення React/TS через вайбкодінг досвідченим розробником іншого стеку. Додано посилання на журнал.
